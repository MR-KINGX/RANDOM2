...
def menu_apikey():
    ...
    print(f"{WHITE}[03] {WHITE}OWNER OFFICIAL CHENNAL")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/KINGXMRSW4TI");xyz()
    elif hamii in ["3","03"]:
...
def password5():
    ...
    print(f"")
    print(f'{WHITE}==========================================================')
    print(f"        \x1b[97m[\033[95;42mEXAMPLE TRY 1:\033[0;m]")
    print(f"")
    print(f" 88017 , 88019 , 88018")
    print(f"        \x1b[97m[\033[95;42mEXAMPLE TRY 2 :\033[0;m]")
    print(f"")
    print(f" 017 , 019 , 018")
    print("")
    print(f'{WHITE}==========================================================')
